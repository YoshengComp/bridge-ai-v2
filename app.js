...
case "view_purchase_order":
    ...
    if (
        !conversation.createdPOs ||
        conversation.createdPOs.length === 0
    ) {
                    ...
                    <div class="purchase-confirm-vendor">
                        ...
                        <div class="purchase-confirm-items">
                            ...
                            <button
                                ...
                                onclick="window.open('${po.ragicUrl}', '_blank')"
                            >
...
// 確認建立採購單
// ==========================================
async function confirmCreatePurchaseOrder() {

    console.log("==========================================");
    console.log("✅ 使用者確認建立全部採購單");
    console.log("==========================================");
    ...
    const valid = validatePurchaseDraft();

    if (!valid) {

        console.warn("❌ 採購資料檢查未通過");
...
async function createPurchaseOrder() {
    ...
    try {
        ...
        for (
            ...
            addAIMessage(
                `📄 正在建立第 ${index + 1} / ${purchaseDraft.length} 張採購單\n\n` +
                `🏢 ${group.vendorName}`
            );
